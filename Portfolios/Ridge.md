...
Overall, I had a great time in geometry lab this semester, and enjoyed the opportunity to meet new people, and explore areas of math and programming that I would otherwise not have. I think geometry lab was a great supplemental materials to my core classes. It was very interesting to have discussed topics like dijkstra's or voronoi diagrams in the lab which ultimately appeared in my other classes, like DSA2. Once each person diverged in topics, it was also extremely interesting to follow their developments on topics I would otherwise not have known about. If I were to change anything about what we did this semester, I would devote more time to collaborative projects. Much of the time, it felt like people went off on their own personal implementations or projects rather than working together in a shared code-base. I think it would have been a cool experience to pair program or work in the same file independently, rather than everyone having their own implementation of a core algorithm. Additionally, I wished we implemented more applications of geometric algorithms. Mitansh discussed interesting use-cases of voronoi diagrams in sports analytics, and Matthew developed a personal project around Google's page rank algorithm. It would have been to implement these or more applications, and utilize some of our algorithms for real-life purposes. Some topics we could have done would be the use of voronoi diagrams for k-nearest neighbor data classification or for game theory and devising where to place new business locations compared to competitors. Ultimately, I thoroughly enjoyed my experience in the lab, and it further my skills both in mathematics and programming.
